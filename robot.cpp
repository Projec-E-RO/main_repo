...
#include "md_robot_node/main.hpp"#include <stdint.h>
#include "md_robot_node/global.hpp"
...
int16_t * RobotSpeedToRPMSpeed(double linear, double angular)
{
    ...
    wheel_velocity_cmd[LEFT]   = linear - (angular * wheel_separation / 2); //좌방향
    wheel_velocity_cmd[RIGHT]  = linear + (angular * wheel_separation / 2); // 우방향
